            ...
            <div class="form-group">
                    <img class="preview-img">    
                      <div class="file-chooser fileUpload">
                        ...
                        <input type="file" class="upload" accept="image/*" name="arquivo" id="capaFilme" value= 
                        <?php 
                        $filmeID = $_POST['filmeID'];

                         $consulta = $objBanco->query("SELECT destino_foto, filmeID 
                         FROM filmes
...
<section class="section_filmes">
  <div class="form-group">
      ...
      <input type="text" class="form-control text-gray bg-light" id="nomeFilme" name="nomeFilme" placeholder="Ex.: Shrek 2" value= 
      <?php 
                                $filmeID = $_POST['filmeID'];

                                $consulta = $objBanco->query("SELECT nomeFilme, filmeID 
                                FROM filmes
                                WHERE filmeID = $filmeID");
